...
public class EntryTest {
  ...
  public void getStringReturnsEmptyString() throws BadTypeException {
    entry = new Entry("");
    assertEquals("getString did not return a value equal "
        + "the value passed into the constructor", entry.getString(), "");
  ...
  /**
   * Test 12 - Tests if <code>getType</code> returns <code>Type.NUMBER</code>
  ...
  public void hashCodesNotEqualFloats() {
    ...
    assertNotEquals(
        "hashCode() returned the same value for non-equal" + " Entry objects",
        entry.hashCode(), entry2.hashCode());
  ...
  public void entriesNotEqualFloatsReturnsFalse() {
    ...
    entry2 = new Entry(1.0f);
    assertNotEquals(
        "equals() did not return false for non-equivilant" + " Entry objects",
        entry, entry2);
  ...
  public void toStringReturnsEmptyString() {
    ...
    assertEquals("toString() did not return a string equal"
        + "the string passed into thse constructor", "", entry.toString());
  ...
  public void toStringReturnsLargerString() {
    entry = new Entry("2 + 4");
    assertEquals(
        "toString() did not return a string equal"
  ...
  public void toStringReturnsSymbol() {
    ...
    assertEquals("toString() did not return a string that represents"
        + "the Symbol passed into thse constructor", "(", entry.toString());
  ...
  public void toStringReturnsNumber() {
    entry = new Entry(0.0f);
    assertEquals(
        "toString() did not return a string that represents"
